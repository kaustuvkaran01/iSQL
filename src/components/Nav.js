...
import logo from '../assets/atlan-logo.png';
export default function Nav() {
  return (
    <header className="p-4 bg-coolGray-800 text-coolGray-100">
	<div className="container flex justify-between h-16 mx-auto">
		<ul className="items-stretch hidden space-x-3 lg:flex">
			...
			<li className="flex">
				<Link to="/" className="flex items-center -mb-0.5 border-b-2 px-4 border-transparent">EXPLORE</Link>
			</li>
		</ul>
		<Link to="/" aria-label="Back to homepage" className="flex items-center p-2">
			<img className="w-36" src={logo} alt="atlan"/>
		</Link>
